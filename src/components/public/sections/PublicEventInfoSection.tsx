...
export const PublicEventInfoSection: React.FC<Props> = ({ data, className = "" }) => {
  ...
  return (
    <MotionReveal id="about" className={`max-w-5xl mx-auto px-6 sm:px-8 py-24 ${className}`}>
      <div className="flex items-center gap-4 mb-10">
        <h2 className="text-3xl md:text-4xl font-bold font-display tracking-tight">About This Event</h2>
