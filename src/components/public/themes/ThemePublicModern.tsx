...
export const ThemePublicModern: React.FC<Props> = ({ data }) => (
  <div className="min-h-screen bg-[hsl(220,20%,97%)] text-[hsl(220,30%,15%)]">
    <PublicStickyNav data={data} className="[&_nav>div]:bg-[hsl(220,20%,97%)]/90" />
    <PublicHeroSection data={data} parallax className="min-h-[380px] flex items-end bg-[hsl(220,60%,50%)]" />
    ...
    <PublicAgendaSection data={data} className="[&_div]:rounded-xl [&_div]:shadow-sm" />
    <PublicSpeakersSection data={data} className="[&_div]:rounded-2xl [&_div]:shadow-md" />
    <PublicVenueSection data={data} />
    <PublicGallerySection data={data} className="[&_button]:rounded-xl" />
    <PublicOrganizersSection data={data} />
    <PublicDressCodeSection data={data} className="[&_div]:rounded-xl [&_div]:shadow-sm" />
    <PublicTransportSection data={data} className="[&_div]:rounded-xl [&_div]:shadow-sm" />
    <PublicSurveyCtaSection data={data} className="[&_div]:bg-[hsl(220,60%,96%)] [&_button]:bg-[hsl(220,60%,50%)]" />
