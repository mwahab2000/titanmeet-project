...
-- Update get_user_usage to use billing cycle dates from account_subscriptions
...
BEGIN
  -- Get billing cycle start from account_subscriptions (anchored to signup date, not month start)
  SELECT COALESCE(
